...
namespace  kittingStatus.jabil.web.DAL
{
    ...
    public abstract class DbHelper
    {
        ...
        public static  string ConnectionString
        {
            get
            {
                if (string.IsNullOrWhiteSpace(m_connection))
                {
                    m_connection = ValidateConnectString("DBCenter");
                }
            ...
            set
            {
                m_connection = ValidateConnectString(value);
            }
        }
		...
		public static string ValidateConnectString(string connectionString)
        {
