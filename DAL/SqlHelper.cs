...
namespace  kittingStatus.jabil.web.DAL
{
    public class SqlHelper
    {
        ...
        //Data Source=cnhuam0sql05;Initial Catalog=Stencil_Life;Persist Security Info=True;User ID=Stencil;Password=HuaStencil
      //  public static readonly string CONN_STRING_DEFAULT ="server=HUA-PINATA-SQL;database=eTools;integrated security=SSPI";
        public static readonly string CONN_STRING_DEFAULT = @"Data Source=CNHUAM0LDSQLV2B\INST1;Initial Catalog=eTools;Persist Security Info=True;User ID=HuameApp;Password=Jabil..123@meapp";
