...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script>
     ...
     var YorN=eval(<%=YorN%>); 
      ...
      var ToolSide_list=eval(<%=ToolSide_list%>);

     var From_Model_list=eval(<%=From_Model_list%>);
    ...
    function SaveData()
    {
     ...
     var _ToolSide=$("#ToolSide option:selected").text();

     var _From_Model=$("#From_Model option:selected").text();
     var _From_ToolSide=$("#From_Side option:selected").text();
...
//     $.ajax({
//            url: "../Data/SaveTask.ashx?Workcell="+_Workcell+"&BayName="+_BayName+"&Model="+_Model+"&ToolSide="+_ToolSide+"&ExpectedTime="+_ExpectedTime,
//            contentType: 'application/json; charset=utf-8',
//            timeout: 5000,                                                                                                        
//            datatype: "html",          
//            success: function (data) {                  
...
//        }); //end ajax  
        ...
        $.post("../Data/SaveTask.ashx",{"Workcell":_Workcell,"BayName":_BayName,"Model":_Model,"ToolSide":_ToolSide,"From_Model":_From_Model,"From_ToolSide":_From_ToolSide,"ExpectedTime":_ExpectedTime,"Share_DEKPallet":_Share_DEKPallet,"ShareSqueegee":_ShareSqueegee},
                 function(data)
                 {                      
                 });
        ...
        <div class="navbar navbar-default" role="navigation">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">                   
                    <li><a href="WebForm_ByModle.aspx">HP Report</a></li>
       ...
       <div class="center-block" style="width:650px;background-color:#a8ce76; padding:25px; box-shadow: 3px 3px 3px;  ">
           <table>
               ...
               <tr style="height: 50px;">
                   ...
                   <td>
                       <select id="From_Model" style="width: 400px;">
                       </select>
                   </td>
               </tr>
               ...
               <tr style="height: 50px;">
                   ...
                   <td>
                       <select id="From_Side" style="width: 400px;">
                       </select>
                   </td>
               </tr>
               ...
               <tr style="height: 50px;">
                   ...
                   <td>
                       <select id="ToolSide" style="width: 400px;">
                       </select>
                   </td>
               </tr>
