    ...
    <div class="modal-dialog">  
        <div class="modal-content">  
            <div class="modal-header">              
                ...
                <h4 class="modal-title" id="H1">EditAction</h4>  
            </div>  
            <div class="modal-body">  
               <div class="container-fluid">
											<form class="form-horizontal">
												<div class="form-group ">
													<label for="Max_Times_temp" class="col-xs-2 control-label">Action:</label>
													<div class="col-xs-10 ">
														<input type="text" class="form-control input-sm duiqi" id="ActionText" placeholder="">
													</div>
												</div>
											</form>
										</div>
