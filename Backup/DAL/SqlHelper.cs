...
namespace  kittingStatus.jabil.web.DAL
{
    public class SqlHelper
    {
      ...
      //  public static readonly string CONN_STRING_DEFAULT ="server=HUA-PINATA-SQL;database=eTools;integrated security=SSPI";
        public static readonly string CONN_STRING_DEFAULT = "Data Source=HUA-PINATA-SQL;Initial Catalog=eTools;Persist Security Info=True;User ID=HuameApp;Password=Jabil..123@meapp";
